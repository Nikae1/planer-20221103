				...
				while (isLoop) {
					...
					if (menuSelection.toUpperCase().equals("0")) {
						...
						if(menuSelection.equals("2")){
							...
							String[] userSelection = { "Start Date | ", "Date Time | ", "contents | ","commet | " };
...
//	private String makeClientData(String menuSelection, String[] accessInfo) {
//		StringBuffer clientData = new StringBuffer();
//		clientData.append("serviceCode="+menuSelection+"accessCode="+ accessInfo[0]);
//		
//		return clientData.toString();
//	}
